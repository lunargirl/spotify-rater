interface LoginViewProps {
  ...
  /** Absolute URL so OAuth always starts on the same host as SPOTIFY_REDIRECT_URI (127.0.0.1). */
...
export function LoginView({ errorCode, spotifyAuthUrl }: LoginViewProps) {
